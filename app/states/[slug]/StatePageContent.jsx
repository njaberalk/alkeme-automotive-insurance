  ...
  return (
    <div ref={ref} className="bg-stone fade-in-view" style={{ padding: '4rem 0' }}>
      <div className="max-w-[68rem] mx-auto px-[60px] max-lg:px-6 max-md:px-4">
        <h2 className="text-brand font-bold leading-[1.3] tracking-tight mb-6" style={{ fontSize: '1.5rem' }}>Automotive Insurance in Nearby States</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="space-y-2">
              {['garage-liability', 'garage-keepers', 'dealers-open-lot', 'general-liability', 'workers-compensation'].map(slug => (
          ...
          <div>
            ...
            <div className="space-y-2">
              {['franchise-dealerships', 'used-car-dealers', 'auto-repair-shops', 'collision-body-shops', 'tire-shops'].map(slug => (
          ...
          <div>
            ...
            <div className="space-y-2">
              {[
                { slug: 'automotive-insurance-cost', label: 'How Much Does Automotive Insurance Cost?' },
                { slug: 'garage-liability-guide', label: 'Garage Liability Guide' },
                { slug: 'garagekeepers-guide', label: 'Garagekeepers Guide' },
                { slug: 'dealers-open-lot-guide', label: 'Dealers Open Lot Guide' },
              ].map(r => (
        ...
        <section className="bg-stone" style={{ padding: '5rem 0' }}>
          <div className="max-w-[900px] mx-auto px-[60px] max-lg:px-6 max-md:px-4">
            <h2 className="text-brand font-bold leading-[1.3] tracking-tight mb-8 text-center" style={{ fontSize: 'clamp(1.8rem, 3vw, 2.2rem)' }}>
              Automotive Insurance FAQ — {state.name}
            </h2>
